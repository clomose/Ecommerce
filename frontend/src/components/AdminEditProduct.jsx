...
const AdminEditProduct = ({
    ...
    const handleOnSubmit = async(e) => {
        ...
        const response = await axios.post(SummaryApi.updateProduct.url,data,{withCredentials: true});
    ...
    return (
        <div className='fixed bg-slate-400 bg-opacity-35 bottom-0 top-0 right-0 z-10 left-0 flex justify-center items-center'>
            <div className='p-4 bg-white roundex w-full max-w-2xl h-full max-h-[80%] overflow-hidden'>
                ...
                <form className='grid gap-2 p-4 overflow-y-scroll h-full' onSubmit={handleOnSubmit}>
                    ...
                    <button className='px-3 py-2 bg-red-600 hover:bg-red-700 text-white mb-10'>Update Product</button>
                </form>
            </div>
            {
                openFullScreenImage && (
